...
export const siteProjectsContent = {
    catalog: {
      ...
      "LLM-Benchmark-Studio": {
        ...
        language: "Python",
        languages: ["Python", "TypeScript", "Vue", "CSS", "HTML", "Dockerfile"],
        updated: "2026-06-05",
      ...
      "Leetcode-All-Languages-Best-Solutions": {
        name: "Leetcode-All-Languages-Best-Solutions",
      ...
      "chinapost-internship": {
        ...
        language: "Python",
        languages: ["Python", "JavaScript", "CSS", "Shell", "HTML", "Dockerfile"],
        updated: "2026-02-24",
      ...
      "AI-Agent": {
        ...
        languages: ["Jupyter Notebook", "Python", "Dockerfile"],
        updated: "2026-01-27",
      ...
      "professional-agentic-learning": {
        ...
        language: "Python",
        languages: ["Python", "TypeScript", "Vue", "CSS", "Shell", "Dockerfile", "HTML"],
        updated: "2026-03-25",
      ...
      "DeepChrInteract-v2": {
        ...
        language: "Python",
        languages: ["Python", "TeX", "Shell", "Batchfile", "Makefile"],
      ...
      "Apple-Silicon-LLM-Engine-from-Scratch": {
        ...
        language: "Python",
        languages: ["Python", "C++", "Objective-C++", "CMake"],
        updated: "2026-03-31",
      ...
      "gpt-oss": {
        ...
        language: "Python",
        languages: ["Python", "C", "C++", "Metal", "TypeScript", "Objective-C", "CMake"],
        updated: "2026-03-27",
      ...
      "Megatron-LM": {
        ...
        language: "Python",
        languages: ["Python", "Shell", "Standard ML", "C++", "Cuda", "Makefile"],
        updated: "2026-04-02",
      ...
      "billzi2016.github.io": {
        ...
        language: "HTML",
        languages: ["JavaScript", "CSS", "Astro", "Python", "TypeScript"],
      ...
      "FlashcardsAPP": {
        ...
        language: "Python",
        languages: ["Python", "TypeScript", "Vue", "CSS", "Dockerfile", "HTML"],
        updated: "2026-05-14",
      ...
      "label-studio": {
        ...
        language: "TypeScript",
        languages: ["TypeScript", "JavaScript", "Python", "CSS", "HTML", "Shell", "Dockerfile", "Makefile"],
      ...
      "z3": {
        ...
        language: "C++",
        languages: ["C++", "Python", "C#", "TypeScript", "C", "Java", "OCaml", "CMake", "Go", "SMT", "D", "Batchfile", "Starlark", "CodeQL", "Shell", "JavaScript", "Dockerfile", "Makefile"],
      ...
      "RomeInADay": {
        ...
        language: "HTML",
        languages: ["HTML", "Python", "Shell", "Dockerfile"],
      ...
      "http-server-from--scratch": {
        ...
        language: "Jupyter Notebook",
        languages: ["Jupyter Notebook", "HTML"],
      ...
      "leetcode-terminator": {
        ...
        language: "Python",
        languages: ["Python", "HTML", "Shell", "Dockerfile"],
      ...
      "django-with-speckit": {
        ...
        language: "Python",
        languages: ["Python", "Shell", "PowerShell", "HTML", "JavaScript"],
      ...
      "MIMO-FMCW-Radar-Simulator-Multiprocess": {
        ...
        language: "Python",
        languages: ["Python", "Dockerfile"],
        links: [{ url: "https://billzi2016.github.io/MIMO-FMCW-Radar-Simulator-Multiprocess/", label: "Docs" }],
      ...
      "intelligent-esp32-drone-racing-gate-system": {
        ...
        language: "C++",
        languages: ["C++", "Python", "HTML", "Shell", "C"],
      ...
      "mmlock-fmcw-radar-deep-security": {
        ...
        language: "Jupyter Notebook",
        languages: ["Jupyter Notebook", "Python", "TeX"],
      ...
      "distributed-paxos-raft-lab": {
        ...
        language: "Vue",
        languages: ["Vue", "Python", "CSS", "JavaScript", "Shell", "HTML", "Dockerfile"],
      ...
      "MPSBoost": {
        name: "MPSBoost",
        url: "https://github.com/billzi2016/MPSBoost",
        language: "Python",
        languages: ["Python", "Metal"],
        updated: "2026-07-23",
        noteEn: "Fast gradient-boosted decision trees for Apple Silicon. A lightweight, sklearn-style Python API powered by MPS and Metal.",
        noteZh: "面向 Apple Silicon 的高性能梯度提升决策树引擎，采用 MPS 与 Metal 加速，提供轻量且兼容 scikit-learn 风格的 Python API。",
      },
      "gpud": {
        name: "gpud",
        url: "https://github.com/billzi2016/gpud",
        language: "Python",
        languages: ["Python", "Shell"],
        updated: "2026-07-21",
        noteEn: "Lightweight declarative elastic GPU scheduling & VRAM offloading framework for PyTorch DDP. Dynamically resize GPU clusters on-the-fly without interrupting training.",
        noteZh: "用于 PyTorch DDP 的轻量级声明式弹性 GPU 调度与显存 Offloading 框架，支持在不中断训练的前提下动态调整 GPU 集群。",
      },
      "tirt-ocean-quiz": {
        name: "tirt-ocean-quiz",
        url: "https://github.com/billzi2016/tirt-ocean-quiz",
        language: "TypeScript",
        languages: ["TypeScript", "Astro", "CSS", "HTML"],
        links: [{ url: "https://billzi2016.github.io/tirt-ocean-quiz/", label: "Demo" }],
        updated: "2026-07-21",
        noteEn: "Adaptive forced-choice Big Five assessment with AI-driven scoring and 1,015,342-response calibration.",
        noteZh: "基于自适应迫选测试（TIRT）的大五人格测评系统，融合 AI 打分与 100 万+ 样本校准，并部署为在线演示页面。",
      },
      "english-reading-practice": {
        name: "english-reading-practice",
        url: "https://github.com/billzi2016/english-reading-practice",
        language: "TypeScript",
        languages: ["TypeScript", "Astro", "CSS", "HTML"],
        links: [{ url: "https://billzi2016.github.io/english-reading-practice/", label: "Demo" }],
        updated: "2026-07-21",
        noteEn: "An Astro-powered English reading practice site with bilingual vocabulary support built for article-driven learning workflows.",
        noteZh: "基于 Astro 构建的双语英文阅读练习与词汇积累平台，围绕可维护的文章驱动学习工作流展开。",
      },
      "too-simple-ai": {
        name: "too-simple-ai",
        url: "https://github.com/billzi2016/too-simple-ai",
        language: "Python",
        updated: "2026-07-20",
        noteEn: "A deliberately simple foundation for practical AI workflows, built with PyTorch, scikit-learn, and pandas.",
        noteZh: "极简实用的 AI 工作流基础库，基于 PyTorch、scikit-learn 和 pandas，专注于清晰易懂的核心实现。",
      },
      "awesome-LLMs": {
        name: "awesome-LLMs",
        url: "https://github.com/billzi2016/awesome-LLMs",
        language: "Markdown",
        updated: "2026-07-17",
        noteEn: "A tree-structured repository for curated LLM topics, covering reasoning, RAG, multimodal systems, agents, MCP, skills, and diffusion LLMs.",
        noteZh: "树状大语言模型前沿主题精选资源库，覆盖推理、RAG、多模态系统、Agent、MCP、Skill 与 Diffusion LLM 等演进方向。",
      },
      "awesome-flow-matching": {
        name: "awesome-flow-matching",
        url: "https://github.com/billzi2016/awesome-flow-matching",
        language: "Python",
        languages: ["Python", "Markdown"],
        updated: "2026-07-17",
        noteEn: "A curated bilingual resource list for Flow Matching, Rectified Flow, stochastic interpolants, and runnable toy examples.",
        noteZh: "Flow Matching、Rectified Flow 与随机插值（stochastic interpolants）的双语资源清单与可运行演示代码。",
      },
      "homemade-datarobot": {
        name: "homemade-datarobot",
        url: "https://github.com/billzi2016/homemade-datarobot",
        language: "Python",
        updated: "2026-07-17",
        noteEn: "A controllable AutoML experimentation system with MLflow tracking, sklearn and PyTorch model pipelines.",
        noteZh: "受控的 AutoML 实验系统，结合 MLflow 追踪、sklearn 与 PyTorch 模型流水线，提供结构化的自动化机器学习实践。",
      },
      "NodeExporter-Prometheus-Grafana": {
        name: "NodeExporter-Prometheus-Grafana",
        url: "https://github.com/billzi2016/NodeExporter-Prometheus-Grafana",
        language: "Python",
        languages: ["Python", "Shell", "Dockerfile"],
        updated: "2026-07-17",
        noteEn: "A macOS-focused observability project combining official Node Exporter, FastAPI exporter, Prometheus, and Grafana.",
        noteZh: "面向 macOS 的可观测性实践项目，整合官方 Node Exporter、自定义 FastAPI Exporter、Prometheus 与 Grafana，对比容器侧与宿主机监控。",
      },
      "reversi-mcts-rl-zero": {
        name: "reversi-mcts-rl-zero",
        url: "https://github.com/billzi2016/reversi-mcts-rl-zero",
        language: "Python",
        updated: "2026-07-17",
        noteEn: "AlphaZero-style Reversi training system with PyTorch policy-value networks, parallel self-play workers, and Monte Carlo Tree Search.",
        noteZh: "AlphaZero 风格的黑白棋强化学习训练系统，结合 PyTorch 策略价值网络、并行 Self-play 自对弈与 MCTS 蒙特卡洛树搜索。",
      },
      "reversi-minimax-alphabeta": {
        name: "reversi-minimax-alphabeta",
        url: "https://github.com/billzi2016/reversi-minimax-alphabeta",
        language: "Python",
        updated: "2026-07-17",
        noteEn: "Automated Reversi engine using minimax and alpha-beta pruning, with full-game rendering and move-by-move board visualization.",
        noteZh: "基于 Minimax 与 Alpha-Beta 剪枝的自动化黑白棋引擎，支持全局对局渲染与逐步棋盘动态可视化。",
      },
      "gomoku-terminator": {
        name: "gomoku-terminator",
        url: "https://github.com/billzi2016/gomoku-terminator",
        language: "Python",
        updated: "2026-07-17",
        noteEn: "CPU-first Gomoku AI featuring readable Python logic, Numba-accelerated search, and bitboard-based high-performance gameplay engines.",
        noteZh: "CPU 优先的高性能五子棋 AI，包含可读 Python 逻辑、Numba 加速搜索与位棋盘（Bitboard）的高效博弈引擎。",
      },
      "maze-algorithms": {
      ...
      "homemade-risc-v-64-vector-linux-emulator": {
        name: "homemade-risc-v-64-vector-linux-emulator",
        url: "https://github.com/billzi2016/homemade-risc-v-64-vector-linux-emulator",
        language: "C++",
        links: [
          {
            url: "https://billzi2016.github.io/homemade-risc-v-64-vector-linux-emulator/",
            label: "Docs",
          },
        ],
        noteEn: "A from-scratch educational 64-bit RISC-V emulator with Vector extension support and the ability to boot Linux. The project turns instruction decoding, privilege levels, memory management, devices, vector execution, and operating-system boot into an inspectable systems-engineering implementation.",
        noteZh: "这是一个从零实现的教学型 64 位 RISC-V 模拟器，支持向量扩展并能够启动 Linux。项目把指令解码、特权级、内存管理、设备、向量执行和操作系统启动过程整合成一套可观察、可学习的系统工程实现。",
        updated: "2026-07-17",
      },
      "homemade-cpu-raytracer": {
        name: "homemade-cpu-raytracer",
        url: "https://github.com/billzi2016/homemade-cpu-raytracer",
        language: "Python",
        noteEn: "A pure-CPU Python renderer that compares rasterization, ray casting, Whitted ray tracing, radiosity, and physically based path tracing in a shared Cornell Box scene. It emphasizes energy conservation, reproducible validation, and a maintainable rendering architecture.",
        noteZh: "这是一个纯 CPU 的 Python 渲染器，在统一的 Cornell Box 场景中比较光栅化、光线投射、Whitted 光线追踪、辐射度和基于物理的路径追踪，并强调能量守恒、可复现验证与可维护的渲染架构。",
        updated: "2026-07-17",
      },
      "SFCN-4-Quadrant-Assessment": {
        name: "SFCN-4-Quadrant-Assessment",
        url: "https://github.com/billzi2016/SFCN-4-Quadrant-Assessment",
        language: "Python",
        noteEn: "A PyTorch four-quadrant SFCN assessment framework for comparing real and generated MRI through age-bin classification experiments. It organizes real-to-real, real-to-generated, generated-to-real, and generated-to-generated evaluation into one reproducible medical-imaging workflow.",
        noteZh: "这是一个基于 PyTorch 的四象限 SFCN 评估框架，通过年龄区间分类实验比较真实 MRI 与生成 MRI，并把真实到真实、真实到生成、生成到真实和生成到生成的评估组织成统一、可复现的医学影像工作流。",
        updated: "2026-07-17",
      },
      "mcts-cpu-validate": {
        name: "mcts-cpu-validate",
        url: "https://github.com/billzi2016/mcts-cpu-validate",
        language: "Python",
        links: [{ url: "https://billzi2016.github.io/mcts-cpu-validate/", label: "Docs" }],
        noteEn: "A reproducible CPU validation system for long-running Monte Carlo Tree Search self-play experiments. It preserves checkpoints, metrics, logs, and game records so training behavior can be inspected, resumed, and compared reliably over time.",
        noteZh: "这是一个面向长期蒙特卡洛树搜索自对弈实验的可复现 CPU 验证系统，通过保存检查点、指标、日志和对局记录，让训练过程能够被稳定检查、恢复和长期比较。",
        updated: "2026-07-14",
      },
      "AI-Solar-Panel-Defect-Detection-Deployment": {
        name: "AI-Solar-Panel-Defect-Detection-Deployment",
        url: "https://github.com/billzi2016/AI-Solar-Panel-Defect-Detection-Deployment",
        language: "Python",
        languages: ["Python", "Shell"],
        links: [{ url: "https://billzi2016.github.io/AI-Solar-Panel-Defect-Detection-Deployment/", label: "Docs" }],
        ...
        noteZh: "这是一个面向部署的太阳能板缺陷检测项目，覆盖 EL / PV 图像、数据集组织、模型流程和公开文档。它是比较完整的应用计算机视觉项目，因为重点不只是 Notebook 结果，而是把缺陷识别和可部署项目包装连接起来。",
        images: [
          {
            src: "./assets/images/projects/AI-Solar-Panel-Defect-Detection-Deployment/readme_dataset_gallery.jpg",
            captionEn: "Dataset Gallery",
            captionZh: "数据集图像展示",
          },
          {
            src: "./assets/images/projects/AI-Solar-Panel-Defect-Detection-Deployment/readme_gallery_elpv.jpg",
            captionEn: "ELPV Examples",
            captionZh: "ELPV 示例",
          },
          {
            src: "./assets/images/projects/AI-Solar-Panel-Defect-Detection-Deployment/readme_gallery_pv_multi_defect.jpg",
            captionEn: "PV Multi-Defect Examples",
            captionZh: "PV 多缺陷示例",
          },
          {
            src: "./assets/images/projects/AI-Solar-Panel-Defect-Detection-Deployment/readme_gallery_pvel_ad.jpg",
            captionEn: "PVEL-AD Examples",
      ...
      "Gomoku-AI": {
        name: "Gomoku-AI",
        url: "https://github.com/billzi2016/Gomoku-AI",
        language: "Rust",
        languages: ["Rust", "JavaScript", "Python", "CSS", "HTML", "Shell"],
        links: [
          { url: "https://billzi2016.github.io/Gomoku-AI/", label: "Demo" },
          { url: "https://billzi2016.github.io/Gomoku-AI/docs/", label: "Docs" },
        ],
      ...
      "Othello-AI": {
        name: "Othello-AI",
        url: "https://github.com/billzi2016/Othello-AI",
        language: "Rust",
        languages: ["Rust", "JavaScript", "CSS", "HTML", "Python"],
        links: [
          { url: "https://billzi2016.github.io/Othello-AI/", label: "Demo" },
          { url: "https://billzi2016.github.io/Othello-AI/docs/", label: "Docs" },
        ],
      ...
      "4096-expectimax-bitboard": {
        ...
        url: "https://github.com/billzi2016/4096-expectimax-bitboard",
        language: "Python",
      ...
      "guesswho-ai-from-scratch": {
        ...
        url: "https://github.com/billzi2016/guesswho-ai-from-scratch",
        language: "JavaScript",
        languages: ["Python", "HTML"],
        links: [{ url: "https://billzi2016.github.io/guesswho-ai-from-scratch/", label: "Demo" }],
        noteEn: "A from-scratch browser guessing-game AI that narrows candidates through yes/no questions and exposes the reasoning path in a simple interactive interface. It is useful as an educational search and decision-tree style demo.",
        noteZh: "这是一个从零实现的浏览器猜人 AI，通过是 / 否问题逐步缩小候选，并在简单交互界面中展示推理路径。它适合作为搜索与决策树思路的教学型演示。",
        images: [
          {
            src: "./assets/images/projects/guesswho-ai-from-scratch/demo.png",
            captionEn: "GuessWho AI Demo",
      ...
      "Receipt-MLLM-OCR": {
        ...
        url: "https://github.com/billzi2016/Receipt-MLLM-OCR",
        language: "Python",
      ...
      "Deep-Learning-The-Definitive-Guide": {
        ...
        url: "https://github.com/billzi2016/Deep-Learning-The-Definitive-Guide",
        language: "Jupyter Notebook",
      ...
      "Facial-Recognition": {
        ...
        url: "https://github.com/billzi2016/Facial-Recognition",
        language: "Python",
      ...
      "Recommender-Systems": {
        ...
        url: "https://github.com/billzi2016/Recommender-Systems",
        language: "Python",
        languages: ["Python", "Shell"],
      ...
      "generative-models": {
        ...
        url: "https://github.com/billzi2016/generative-models",
        language: "Python",
        languages: ["Python", "Shell"],
      ...
      "SFCN-age-gender-balanced": {
        ...
        url: "https://github.com/billzi2016/SFCN-age-gender-balanced",
        language: "Python",
        languages: ["Python", "Shell"],
      ...
      "tennis-for-two": {
        name: "tennis-for-two",
        url: "https://github.com/billzi2016/tennis-for-two",
        language: "JavaScript",
      ...
      "python-git-reproduction": {
        ...
        url: "https://github.com/billzi2016/python-git-reproduction",
        language: "Python",
